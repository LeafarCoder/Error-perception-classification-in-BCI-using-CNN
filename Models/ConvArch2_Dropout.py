...
class Net(pl.LightningModule):
  ...
  def explainModel():
    ...
    # Model name
    model_name = "ConvArch2_Dropout"
    text += "<h1>{}</h1>".format(model_name)

    # Model key points
    key_points =   """
    <p>The main model idea is taken from the paper:<br>
    ...
    <p>It defines a 5 layers CNN architecture and adds Dropout to try to improve on the ConvArch1.</p>
    """
